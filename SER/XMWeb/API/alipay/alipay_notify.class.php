...
class AlipayNotify {
	...
	function __construct(){
		$this->alipay_config = include(dirname(__file__)."/config.class.php");
	}
    function AlipayNotify() {
    	$this->__construct();
    }
    function paylog($data){
        $file_path= dirname(__file__).'/paylog.txt';
        $con=date('Y-m-d H:i:s', time()).PHP_EOL.print_r($data,true).PHP_EOL;
