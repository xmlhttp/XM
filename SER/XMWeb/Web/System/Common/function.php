...
//导出Excel
function exportExcel($expTopName,$expCellName,$expTableData){
	$fileName = time();//or $xlsTitle 文件名称可根据自己情况设定
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', $expTopName.' - 导出时间:'.date('Y-m-d H:i:s'));  
	for($i=0;$i<$cellNum;$i++){
