...
<head>
	<title>Present by vmuui.com 管理中心 - 充取记录</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/ManagerPage/Count">平台信息</a>><a href="javascript:void(0)">充取记录</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">

<div class="tab_txt">
<div class="tab_tit"><span>此处为平台的充电取款记录</span>充取记录</div>
...
<div class="meun_tab">
  ...
  <table  width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr>
	  ...
	  <td width="70" align="right">商家编号：</td>
...
<script>
	$("#keywords").val("");
var	myGridmode='/System.php?s=/System/InSome/', //模块地址
	myGrid = new dhtmlXGridObject('gridbox');
	myGrid.setImagePath("/Web/System/Public/Tool/codebase/imgs/dhxgrid_material/");

	var	myGridnum=10; //选中框所在的下标
	myGrid.setHeader("ID,商家名称,类别,充电次数,取款次数,变化金额,实际金额,变化电量,累计充电,加入时间");
	myGrid.setInitWidths("60,*,80,80,80,100,120,100,120,150");
