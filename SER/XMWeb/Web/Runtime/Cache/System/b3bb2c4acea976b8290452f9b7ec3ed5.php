...
<head>
	<title>Present by vmuui.com 管理中心 - 电表日志</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/SiteListAll">运营信息</a>><a href="/System.php?s=/System/Pnote">设备日志</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">

<div class="tab_txt">
<div class="tab_tit">设备日志</div>
...
<div class="meun_tab">
  ...
  <table  width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="60" align="right">设备ID：</td>
...
<?php if((session('adminclass') == 1) OR (session('adminclass') == 99)): ?>var	myGridnum=8; //选中框所在的下标
	myGrid.setHeader("ID,商家名称,桩名,电度,电压,电流,说明,加入时间");
	myGrid.setInitWidths("80,120,120,80,80,80,*,160");
	myGrid.setColAlign("center,left,left,center,center,center,left,center");
	myGrid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro");
	myGrid.setColSorting("int,str,str,str,str,str,str,str");
<?php else: ?>
	var	myGridnum=7; //选中框所在的下标
	myGrid.setHeader("ID,桩名,电度,电压,电流,说明,加入时间");
	myGrid.setInitWidths("80,120,80,80,80,*,160");
	myGrid.setColAlign("center,left,center,center,center,left,center");
