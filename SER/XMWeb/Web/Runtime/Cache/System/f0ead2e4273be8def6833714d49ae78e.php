...
<head>
	<title>Present by vmuui.com 管理中心 - 订单列表</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/ManagerPage/Count">平台信息</a>><a href="javascript:void(0)">订单列表</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">

<div class="tab_txt">
<div class="tab_tit"><span>此处为订单列表，可查看订单原始记录</span>订单列表</div>
...
<script>
	$("#keywords").val("");
var	myGridmode='/System.php?s=/System/OrderList/', //模块地址
	myGrid = new dhtmlXGridObject('gridbox');
	myGrid.setImagePath("/Web/System/Public/Tool/codebase/imgs/dhxgrid_material/");

var	myGridnum=8; //选中框所在的下标
	myGrid.setHeader("ID,订单编号,交易标题,变化金额,交易状态,开始时间,结束时间,订单详情");
	myGrid.setInitWidths("80,160,*,100,80,150,150,80");
	myGrid.setColAlign("center,left,left,center,center,center,center,center");
	myGrid.setColTypes("ro,ed,ro,ro,ro,ro,ro,link");
