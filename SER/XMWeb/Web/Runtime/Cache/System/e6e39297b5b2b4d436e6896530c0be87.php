...
<head>
	<title>Present by vmuui.com 管理中心- 站点列表</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/SiteListAll">运营信息</a>><a href="javascript:void(0)">站点列表</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">
...
<div class="meun_tab">
  ...
  <table  width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td  align="right">
      <input name="button" type=button class="btn" onClick="item_up()" value="上移"  style="width:55px"/>&nbsp;<input name="button" type=button class="btn" onClick="item_down()" value="下移"  style="width:55px"/>&nbsp;<input name="button" type=button class="btn" onClick="delete_items()" value="删除选中" />&nbsp;
	  <?php if(session('adminclass') == 0): ?><input name="button" type=button class="btn" onClick="window.location.href='/System.php?s=/System/SiteListAll/AddRead'" value="添加站点" /><?php endif; ?> </td>
    </tr>
  </table>
</div>
<div class="db_div" >
