...
<form  method="post"  id="form1" action="<?php echo U('/System/ManagerPage/MailSet_updata');?>" >
    <table width="100%" border="0" cellpadding="2" cellspacing="0"  class="siteup_tab">
        ...
        <tr>
          ...
          <td align="left"><input type="button" id="addsave" class="btn" value="保存参数" style=" width:144px; height:30px" /><input type="button" id="chkset" class="btn" value="检测SMTP设置" style=" width:144px; height:30px; margin-left:20px" />
          </td>
        </tr>
