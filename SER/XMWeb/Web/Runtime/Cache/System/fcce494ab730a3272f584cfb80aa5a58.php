...
<!--右侧一结束-->
<!--右侧二开始-->
<ul class="top_r2" style="width:300px"><li><a href="http://<?php echo ($web); ?>" target="_blank">网站首页</a></li><li><a href="<?php echo U('/System/ManagerPage/BaseInfo');?>"  target="frame_right">系统首页</a></li><li class="last"><a  href="/System.php?s=/System/Log"   target="frame_right">系统管理</a></li></ul>
<!--右侧二结束-->

<!--左侧logo开始-->
<a class="logo" href="http://<?php echo ($web); ?>" title="公司官网" target="_blank"><img src="/Web/System/Public/images/ManagerPage/logo.png" /></a>
