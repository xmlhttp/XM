...
<head>
	<title>Present by vmuui.com 管理中心 - 错误信息</title>
...
<div class="tab_txt">
<div class="tab_tit"><span>此处为平台反馈的部分错误</span>错误信息</div>
...
<div class="meun_tab">
  ...
  <table  width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr>
	  ...
	  <td width="70" align="right">信息标题：</td> 
...
<script>
	$("#keywords").val("");
var	myGridmode='/System.php?s=/System/ErrList/', //模块地址
	myGrid = new dhtmlXGridObject('gridbox');
	myGrid.setImagePath("/Web/System/Public/Tool/codebase/imgs/dhxgrid_material/");

var	myGridnum=5; //选中框所在的下标
	myGrid.setHeader("ID,信息标题,信息描述,添加时间");
	myGrid.setInitWidths("80,*,*,150");
