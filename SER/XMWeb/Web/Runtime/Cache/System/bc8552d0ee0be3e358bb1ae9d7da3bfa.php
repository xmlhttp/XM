...
<head>
	<title>Present by vmuui.com 管理中心 - 会员动态</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/UserAll">会员信息</a>><a href="/System.php?s=/System/USou">会员动态</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">

<div class="tab_txt">
<div class="tab_tit">会员动态</div>
...
<div class="meun_tab">
  ...
  <table  width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr>
	  ...
	  <td width="60" align="right">会员ID：</td>
...
<script>
	$("#keywords").val("");
var	myGridmode='/System.php?s=/System/USou/', //模块地址
	myGrid = new dhtmlXGridObject('gridbox');
	myGrid.setImagePath("/Web/System/Public/Tool/codebase/imgs/dhxgrid_material/");
<?php if(session('adminclass') == 1 or session('adminclass') == 99): ?>var	myGridnum=10; //选中框所在的下标
	myGrid.setHeader("ID,用户昵称,充电次数,充电金额,累计金额,充电电量,累计电量,充电时间,累计时间,添加时间");
	myGrid.setInitWidths("60,*,80,80,80,80,80,100,100,150");
	myGrid.setColAlign("center,left,center,center,center,center,center,center,center,center");
	myGrid.setColTypes("ro,link,ro,ro,ro,ro,ro,ro,ro,ro");
	myGrid.setColSorting("int,str,str,str,str,str,str,str,str,str");
	myGrid.init();
<?php else: ?>
	var	myGridnum=9; //选中框所在的下标
	myGrid.setHeader("ID,用户昵称,充电金额,充电电量,充电时间,添加时间");
	myGrid.setInitWidths("80,*,120,120,120,150");
