...
<head>
	<title>Present by vmuui.com 管理中心 - 版本列表</title>
...
<div class="meun_tab">
  ...
  <table  width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="145" align="left"><select name="select" id="menu" style="width:140px; height:28px; line-height:28px; color:#4b4b4b" onchange="searchitem()"><option value="0">所有设备</option><option value="1">有线设备</option><option value="2">无线设备</option></select></td>
	  <td width="60" align="right" style="display:none">关键字：</td>
      <td style="width:170px; text-align:center;display:none">
      ...
      <td  align="right">
      <input name="button" type=button class="btn" onClick="item_up()" value="上移"  style="width:55px"/>&nbsp;<input name="button" type=button class="btn" onClick="item_down()" value="下移"  style="width:55px"/>&nbsp;<input name="button" type=button class="btn" onClick="delete_items()" value="删除选中" />&nbsp;<input name="button" type=button class="btn" onClick="window.location.href='/System.php?s=/System/Down/AddRead'" value="添加版本" /> </td>
    </tr>
  </table>
</div>
<div class="db_div" >
...
var	myGridnum=5, //选中框所在的下标
	myGridmode='/System.php?s=/System/Down/', //模块地址
	myGrid = new dhtmlXGridObject('gridbox'); //新建列表
	myGrid.setImagePath("/Web/System/Public/Tool/codebase/imgs/dhxgrid_material/");
	myGrid.setHeader("ID,版本名称,加入时间,启用,编辑,<a href='javascript:void(0)' onclick='chk_all()'>全选 </a>");
