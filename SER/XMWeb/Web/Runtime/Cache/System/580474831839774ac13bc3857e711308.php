...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/AdminAll">系统信息</a>><a href="/System.php?s=/System/AdminAll">管理员管理</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">
...
<div class="meun_tab">
  ...
  <table  width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td  align="right">
       <input name="button" type=button class="btn" onClick="window.location.href='/System.php?s=/System/AdminAll/AddRead'" value="添加管理员" /> </td>
    </tr>
  </table>
</div>
<div class="db_div" >
...
var	myGridnum=7, //选中框所在的下标
	...
	myGrid.setHeader("ID,用户名,姓名,级别,加入时间,生效,编辑");
	myGrid.setInitWidths("80,*,*,120,160,80,80");
	myGrid.setColAlign("center,left,left,center,center,center,center");
	myGrid.setColTypes("ro,ed,ed,ro,ro,ch,link");
