...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/SiteListAll">运营信息</a>><a href="javascript:void(0)">添加站点</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">
<div class="tab_txt">
<div class="tab_tit">添加站点</div>
    ...
    <tr>
      ...
      <td  align="left"><input type="text" id="linkpwd" name="linkpwd" class="input1" onFocus="this.className='input1-bor'" onBlur="this.className='input1'"  style="width:240px"  /><span style=" margin-left:5px; color:#06F" id="linkpwd_tip">*前端板卡必须与该密码相同</span> <span style=" margin-left:5px; color:#F00; display:none" id="innetip_tip">×链接密码不能为空</span>
      </td>
    </tr>
    
     <tr>
      <td align="right">电费单价：</td>
      <td  align="left"><input type="text" id="uint" name="uint" class="input1" onFocus="this.className='input1-bor'" onBlur="this.className='input1'"  style="width:140px"  /> 元/度<span style=" margin-left:5px; color:#F00; display:none" id="uint_tip">×单价不能为空</span>
      </td>
    </tr>
...
$("#addsave").click(function(){
		...
		/*
		if($("#img").val().replace(/(^\s*)|(\s*$)/g, "").length==0){
			$("#siteimg_tip").show();
			return false;	
		}
