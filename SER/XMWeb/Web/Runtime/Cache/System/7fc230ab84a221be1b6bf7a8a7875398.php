...
<head>
	<title>Present by vmuui.com 管理中心 - 设备管理</title>
...
<div class="meun_tab">
  ...
  <table  width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td  align="right">
     <input name="button" type=button class="btn" onClick="delete_items()" value="删除选中" />&nbsp;<input name="button" type=button class="btn" onClick="window.location.href='/System.php?s=/System/PileListAll/AddRead'" value="添加设备" /> </td>
    </tr>
  </table>
</div>
<div class="db_div" >
...
var myGridnum=9, //选中框所在的下标
	...
	myGrid.setHeader("ID,设备名称,充电,加入时间,启用,联线,车位,编辑,二维码,<a href='javascript:void(0)' onclick='chk_all()'>全选 </a>");
	myGrid.setInitWidths("80,*,80,130,70,70,70,60,60,60");
