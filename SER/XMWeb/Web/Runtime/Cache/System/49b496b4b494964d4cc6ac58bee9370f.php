    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="0"  class="siteup_tab">
        ...
        <tr>
         ...
         <tr>
          ...
          <td align="left"><input type="text" class="input1" onFocus="this.className='input1-bor'" onBlur="this.className='input1'"  style="width:240px" id="tel" name="tel" value="<?php echo ($Site["tel"]); ?>" /></td>
        </tr> 
        <tr>
