...
<head >
	...
	<style>
	.tab_tit span{ float:right; font-size:12px;}
	.tab_tit span b{ letter-spacing:0; color:#f66; font-family:Verdana; font-size:13px; padding-left:3px; padding-right:3px}
	</style>
</head>
<body>
<!--顶部导航开始-->
...
<div class="cont_info">
<div class="tab_txt">
<div class="tab_tit"><span>站点统计：累计收入<b><?php echo ($count["money"]); ?></b>元，累计充电<b><?php echo ($count["sele"]); ?></b>度。</span>修改站点</div>
