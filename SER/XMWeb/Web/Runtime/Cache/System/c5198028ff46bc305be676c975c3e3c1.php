...
<head >
    <title>Present by vmuui.com 管理中心 - 添加版本</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/Down">版本管理</a>><a href="javascript:void(0)">添加版本</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">
<div class="tab_txt">
<div class="tab_tit">添加版本</div>
	...
	<tr>
		...
		<td align="left"><select id="list1" name="list1" class="list1" ><option value="1">有线设备</option><option value="2">无线设备</option></select></td>
    </tr>
    <tr>
    ...
    <tr style="display:none">
      ...
      <td  align="left" style="height:30px">
      	<input type="radio" id="putout1" name="putout" value="1" />是
      	<input type="radio" id="putout2" name="putout" value="0" checked="checked" style="margin-left:20px;" />否
      </td>
    </tr>      
 
    <tr>
      <td align="right" height="50"></td>
      <td  align="left"><input type="button" class="btn" id="addsave" value="添加版本" style=" width:144px; height:30px" /> 
      </td>
    </tr>
  </table>
  </form>
