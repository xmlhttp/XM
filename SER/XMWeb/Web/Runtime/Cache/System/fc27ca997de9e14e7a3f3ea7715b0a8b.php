...
<head >
    <title>Present by vmuui.com 管理中心 - 添加充电桩</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/PileListAll">运营信息</a>><a href="javascript:void(0)">修改设备</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">
<div class="tab_txt">
<div class="tab_tit"><span>设备统计：共充电<b><?php echo ($T["snum"]); ?></b>次，累计收入<b><?php echo ($T["smoney"]); ?></b>元，累计充电<b><?php echo ($T["sele"]); ?></b>度，累计服务时间<?php echo ($T["stime"]); ?></span>修改设备</div>
   ...
   <table width="100%" border="0" cellpadding="2" cellspacing="0" class="info_tab">
    ...
    <tr>
      ...
      <td align="left"><input type="text" id="pilenum" name="pilenum" class="input1" onFocus="this.className='input1-bor'" onBlur="this.className='input1'"  style="width:240px" value="<?php echo ($T["pilenum"]); ?>"  /><span style=" margin-left:5px; color:#F00; display:none" id="pilenum_tip">×板卡名称不能为空</span>
        </td>
    </tr>
	
	<tr>
      <td align="right">桩体编号：</td>
      <td align="left"><input type="text" id="pileNo" name="pileNo" class="input1" onFocus="this.className='input1-bor'" onBlur="this.className='input1'"  style="width:240px"  value="<?php echo ($T["pileNo"]); ?>"  /><span style=" margin-left:5px; color:#F00; display:none" id="pileNo_tip">×桩体编号不能为空</span>
        </td>
    </tr> 
